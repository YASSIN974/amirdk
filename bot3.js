...
bot.on('ready', function(){
    ...
    setInterval(function (){
        ...
        i = i+j;
        bot.user.setGame(setGame[i],`https://www.twitch.tv/skwadraa`);
    }, ms);10000
});
*/
bot.on('ready', function(){
...
bot.on('message', async msg => { // eslint disable line
    if (msg.author.bot) return undefined;
    if (!msg.content.startsWith(p)) return undefined;
    const args = msg.content.split(' ');
    const searchString = args.slice(1).join(' ');
    const url = args[1] ? args[1].replace(/<(.+)>/g, '$1') : '';
    const serverQueue = queue.get(msg.guild.id);
    ...
    if (msg.content.startsWith(`${p}play`)) {
        console.log(`${msg.author.tag} has been used the ${p}play command in ${msg.guild.name}`);
    ...
    } else if (msg.content.startsWith(`${p}skip`)) {
        console.log(`${msg.author.tag} has been used the ${p}skip command in ${msg.guild.name}`);
        if (!msg.member.voiceChannel) return msg.channel.send({embed: {
            color: 15158332,
            fields: [{
                name: "❌ Error",
        ...
        serverQueue.connection.dispatcher.end();
        return undefined;
    } else if (msg.content.startsWith(`${p}stop`)) {
        console.log(`${msg.author.tag} has been used the ${p}stop command in ${msg.guild.name}`);
        if (!msg.member.voiceChannel) return msg.channel.send({embed: {
            color: 15158332,
            fields: [{
                name: "❌ Error",
        ...
        serverQueue.connection.dispatcher.end('Stop command has been used!');
        return undefined;
    } else if (msg.content.startsWith(`${p}volume`)) {
        console.log(`${msg.author.tag} has been used the ${p}volume command in ${msg.guild.name}`);
        if (!msg.member.voiceChannel) return msg.channel.send({embed: {
            color: 15158332,
            fields: [{
                name: "❌ Error",
    ...
    } else if (msg.content.startsWith(`${p}np`)) {
        console.log(`${msg.author.tag} has been used the ${p}np command in ${msg.guild.name}`);
        if (!serverQueue) return msg.channel.send({embed: {
            color: 15158332,
            fields: [{
                name: "❌ Error",
    ...
    } else if (msg.content.startsWith(`${p}queue`)) {
        console.log(`${msg.author.tag} has been used the ${p}queue command in ${msg.guild.name}`);
        if (!serverQueue) return msg.channel.send({embed: {
            color: 15158332,
            fields: [{
                name: "❌ Error",
        ...
        console.log(`${msg.author.tag} has been used the ${p}help command in ${msg.guild.name}`);
        ...
        msg.author.send({embed: {
            ...
            fields: [{
                name: "Bot's commands:",
                value: `**${p}help** - This message!\n\
**${p}play** - Play a song from YouTube.\n\
**${p}skip** - Skip a song.\n\
**${p}stop** - Stops the music.\n\
**${p}volume** - Change the volume of the bot.\n\
**${p}np** - The song that now playing.\n\
**${p}queue** - See the queue of songs.\n\
...
**${p}resume** - Resume the music.`
    ...
    } else if (msg.content.startsWith(`${p}pause`)) {
        console.log(`${msg.author.tag} has been used the ${p}pause command in ${msg.guild.name}`);
        if (serverQueue && serverQueue.playing) {
            serverQueue.playing = false;
        serverQueue.connection.dispatcher.pause();
        return msg.channel.send({embed: {
    ...
    } else if (msg.content.startsWith(`${p}resume`)) {
        console.log(`${msg.author.tag} has been used the ${p}resume command in ${msg.guild.name}`);
